...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiohttp-retry-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13810&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiohttp-retry-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiohttp-retry` can be installed with:

```
conda install aiohttp-retry
```

It is possible to list all of the versions of `aiohttp-retry` available on your platform with:
